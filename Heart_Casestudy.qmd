...
- The model achieved **very high recall (0.80)** on predicting heart disease (class 1), meaning when it predicted disease, it was usually correct.  
- However, the **accuracy dropped to 0.75**, indicating that some true cases of heart disease were missed.  
- Overall performance remains solid with a **macro F1 score of 0.70**, suggesting that the model still generalizes well to unseen data.  
