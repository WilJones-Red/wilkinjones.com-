...
## Big Data — Church Attendance Analysis (Full write-up coming 10/10/2025)

-   **Tools:** Polars, Marimo, Plotly
-   **Goal:** Clean, normalize, and analyze large parquet datasets to uncover patterns in church attendance across LDS and other denominations.
-   **Outcome:** Produced interactive visual dashboards (device usage, hourly attendance trends, and brand co-visitation) enabling clear comparison between LDS and non-LDS locations.
-   [View the temporary write-up](all_questions.html)
